...
#' Detect, whether a tibble containing MSMT is in a long or a wide format
#' 
#' Used to determine optimal mode of joining tibbles. 
#' For these purposes, data is considered to be long, when it either contains 
#' more than one instance of every observed combination of indicator values, or
#' if at least one indicator is missing in the data.
